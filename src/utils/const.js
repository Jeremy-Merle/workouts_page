// const
const MAPBOX_TOKEN =
  'pk.eyJ1IjoiamVyZW15bW8iLCJhIjoiY2w5YTJ4aGR0M283MzNubXhndzV6aG5qOCJ9.ytUQE6ILu0_lQ-YFCKT4Jg';
...
const CHINESE_INFO_MESSAGE = (yearLength, year) =>
  `我用 Apple Watch 记录户外运动 ${yearLength} 年啦 ` + (year === 'Total' ? '' : `，地图展示的是 ${year} 年的轨迹`);
